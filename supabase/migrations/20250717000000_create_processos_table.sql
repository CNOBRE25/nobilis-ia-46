-- Create processos table for NOBILIS-IA
-- This table stores legal processes and investigations
...
INSERT INTO public.processos (
  ...
  (
    ...
    'tramitacao',
    (SELECT id FROM public.users WHERE email = 'admin@nobilis-ia.com' LIMIT 1),
    'João Silva',
    'Cabo',
    '1º BPM'
  ),
  (
    ...
    'tramitacao',
    (SELECT id FROM public.users WHERE email = 'advogado@nobilis-ia.com' LIMIT 1),
    'Maria Santos',
    'Sargento',
    '2º BPM'
  )
